...
列表收集了 [Typst](https://github.com/typst/typst) ⭐ 55,863 | 🐛 1,279 | 🌐 Rust | 📅 2026-09-05 相关的资源,扩展，应用等。
...
* [GitHub](https://github.com/typst/typst) ⭐ 55,863 | 🐛 1,279 | 🌐 Rust | 📅 2026-09-05
...
* [Chinese-Resume-in-Typst](https://github.com/OrangeX4/Chinese-Resume-in-Typst) ⭐ 948 | 🐛 3 | 🌐 Typst | 📅 2025-03-18: 使用 Typst 编写的中文简历, 语法简洁, 样式美观, 开箱即用, 可选是否显示照片
...
* [typst-slides](https://github.com/andreasKroepelin/typst-slides) ⭐ 1,601 | 🐛 98 | 🌐 Typst | 📅 2026-02-28: 创建演示文稿的模板,A template for creating slides in Typst
...
* [typst.ts](https://github.com/Myriad-Dreamin/typst.ts) ⭐ 1,210 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-31: 在 javascript 环境中渲染 typ 文件 ,Typst.ts allows you to independently run the Typst compiler and exporter (renderer) in your browser.
* [typst-py](https://github.com/messense/typst-py) ⭐ 351 | 🐛 9 | 🌐 Rust | 📅 2026-09-01: Typst 的 Python 绑定, Python binding to typst, a new markup-based typesetting system that is powerful and easy to learn.
