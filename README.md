...
列表收集了 [Typst](https://github.com/typst/typst) ⭐ 56,208 | 🐛 1,273 | 🌐 Rust | 📅 2026-09-23 相关的资源,扩展，应用等。
...
* [GitHub](https://github.com/typst/typst) ⭐ 56,208 | 🐛 1,273 | 🌐 Rust | 📅 2026-09-23
...
* [Chinese-Resume-in-Typst](https://github.com/OrangeX4/Chinese-Resume-in-Typst) ⭐ 970 | 🐛 3 | 🌐 Typst | 📅 2025-03-18: 使用 Typst 编写的中文简历, 语法简洁, 样式美观, 开箱即用, 可选是否显示照片
...
* [typst-slides](https://github.com/andreasKroepelin/typst-slides) ⭐ 1,604 | 🐛 98 | 🌐 Typst | 📅 2026-02-28: 创建演示文稿的模板,A template for creating slides in Typst
...
* [typst-canvas](https://github.com/johannes-wolf/typst-canvas) ⭐ 1,850 | 🐛 74 | 🌐 Typst | 📅 2026-09-17: Typst Canvas 库
...
* [typst.ts](https://github.com/Myriad-Dreamin/typst.ts) ⭐ 1,224 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-23: 在 javascript 环境中渲染 typ 文件 ,Typst.ts allows you to independently run the Typst compiler and exporter (renderer) in your browser.
