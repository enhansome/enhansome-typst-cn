...
列表收集了 [Typst](https://github.com/typst/typst) ⭐ 55,969 | 🐛 1,293 | 🌐 Rust | 📅 2026-09-11 相关的资源,扩展，应用等。
...
* [GitHub](https://github.com/typst/typst) ⭐ 55,969 | 🐛 1,293 | 🌐 Rust | 📅 2026-09-11
...
* [Chinese-Resume-in-Typst](https://github.com/OrangeX4/Chinese-Resume-in-Typst) ⭐ 951 | 🐛 3 | 🌐 Typst | 📅 2025-03-18: 使用 Typst 编写的中文简历, 语法简洁, 样式美观, 开箱即用, 可选是否显示照片
* [awesomeCV-Typst](https://github.com/mintyfrankie/awesomeCV-Typst) ⭐ 837 | 🐛 2 | 🌐 Typst | 📅 2026-08-29 - 一份参考 `Awesome-CV` 的简历模版，支持多语言简历管理, An opinionated, relived CV template inspired by the LaTeX `Awesome-CV` project, but with multilingual support and more
...
* [typst-canvas](https://github.com/johannes-wolf/typst-canvas) ⭐ 1,839 | 🐛 76 | 🌐 Typst | 📅 2026-09-11: Typst Canvas 库
...
* [typst-theorems](https://github.com/sahasatvik/typst-theorems) ⭐ 287 | 🐛 26 | 🌐 Typst | 📅 2026-09-12: 一个辅助编号的库,A library for creating numbered theorem environments
...
* [typst-physics](https://github.com/Leedehai/typst-physics) ⭐ 610 | 🐛 9 | 🌐 Typst | 📅 2026-07-21: 物理符号库，A library for usual physics notations, e.g. vectors, matrices, derivatives, Dirac brakets, tensors, isotopes
