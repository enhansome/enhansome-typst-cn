...
列表收集了 [Typst](https://github.com/typst/typst) ⭐ 55,768 | 🐛 1,276 | 🌐 Rust | 📅 2026-08-31 相关的资源,扩展，应用等。
...
* [Awesome Typst 中文版](#awesome-typst-%E4%B8%AD%E6%96%87%E7%89%88)
  ...
  * [库和工具类](#%E5%BA%93%E5%92%8C%E5%B7%A5%E5%85%B7%E7%B1%BB)
    ...
    * [物理 化学 电学](#%E7%89%A9%E7%90%86-%E5%8C%96%E5%AD%A6-%E7%94%B5%E5%AD%A6)
...
* [GitHub](https://github.com/typst/typst) ⭐ 55,768 | 🐛 1,276 | 🌐 Rust | 📅 2026-08-31
...
* [Typst中文文档](https://github.com/Zuttergutao/Typstdocs-Zh-CN-) ⭐ 41 | 🐛 0 | 🌐 Typst | 📅 2023-11-28: 随便翻译的Typst中文文档
...
* [typst/templates](https://github.com/typst/templates) ⭐ 420 | 🐛 23 | 🌐 Typst | 📅 2026-03-20: 官方提供的模板，可以下载，也可以直接在 typst.app 在线服务中使用

### 中国大学论文

* [HUST-typst-template](https://github.com/werifu/HUST-typst-template) ⭐ 238 | 🐛 7 | 🌐 Typst | 📅 2025-06-16: 用于华科毕业设计（本科）的 typst 模板。
* [pkuthss-typst](https://github.com/lucifer1004/pkuthss-typst) ⭐ 166 | 🐛 7 | 🌐 Typst | 📅 2026-05-07: 北京大学学位论文模板,Typst template for dissertations in Peking University (PKU).
...
* [typstry](https://github.com/qjcg/typstry) ⭐ 11 | 🐛 0 | 🌐 TeX | 📅 2023-04-28: 个人编写的模板，A Tapestry of Typst Templates & Examples

* [writable-gm-screen-inserts](https://github.com/LLBlumire/writable-gm-screen-inserts) ⭐ 6 | 🐛 0 | 🌐 Nix | 📅 2023-03-22:类似游戏 cheat sheet, Writable Game Master Screen Inserts

* [tyspt-mla9-template](https://github.com/wychwitch/tyspt-mla9-template) ⭐ 0 | 🐛 0 | 📅 2024-01-20: MLA 第九版模板，An MLA 9th edition template

* [typst-templates](https://github.com/eigenein/typst-templates): 个人编写的模板，Templates for Typst

### 信件

* [typst-din-5008-letter](https://github.com/ludwig-austermann/typst-din-5008-letter) ⭐ 17 | 🐛 2 | 🌐 Typst | 📅 2023-09-18: DIN 5008 标准的商务文稿模板, A template for DIN 5008 inspired typst letter. Furthermore, there is a envelope template.

### 笔记

* [typst-notebook](https://github.com/Fr4nk1in-USTC/typst-notebook) ⭐ 36 | 🐛 1 | 🌐 Typst | 📅 2025-09-10: 简单的笔记模板 ,A simple template for taking notes in Typst.
* [vex-typst-notebook](https://github.com/frosty884/vex-typst-notebook) ⭐ 9 | 🐛 0 | 📅 2023-04-17: Vex 机器人比赛工程笔记模板 ,This repository contains an open source VEX Robotics notebook template for use with the Typst note-taking app.

### 任务 工作 作业

* [typst-assignment-template](https://github.com/gRox167/typst-assignment-template.git) ⭐ 58 | 🐛 0 | 🌐 Typst | 📅 2025-03-24: 作业模板,Yet another simple assignment template with a cover and several useful math symbols.
* [assignment-template](https://github.com/AntoniosBarotsis/typst-assignment-template) ⭐ 15 | 🐛 0 | 📅 2023-03-28: 简单的作业模板,A simple assignment template
* [typst-homework-template](https://github.com/OriginCode/typst-homework-template) ⭐ 13 | 🐛 0 | 📅 2023-04-05: 作业模板,A simple homework template inspired by the LaTeX homework template by Adam Blank
* [typst-assignment-template](https://github.com/astrale-sharp/typst-assignement-template.git) ⭐ 6 | 🐛 0 | 📅 2023-03-27: 作业模板,Yet another simple assignment template

### 简历

* [Chinese-Resume-in-Typst](https://github.com/OrangeX4/Chinese-Resume-in-Typst) ⭐ 943 | 🐛 3 | 🌐 Typst | 📅 2025-03-18: 使用 Typst 编写的中文简历, 语法简洁, 样式美观, 开箱即用, 可选是否显示照片
* [awesomeCV-Typst](https://github.com/mintyfrankie/awesomeCV-Typst) ⭐ 832 | 🐛 2 | 🌐 Typst | 📅 2026-08-29 - 一份参考 `Awesome-CV` 的简历模版，支持多语言简历管理, An opinionated, relived CV template inspired by the LaTeX `Awesome-CV` project, but with multilingual support and more
...
* [typst-slides](https://github.com/andreasKroepelin/typst-slides) ⭐ 1,599 | 🐛 98 | 🌐 Typst | 📅 2026-02-28: 创建演示文稿的模板,A template for creating slides in Typst

## 库和工具类

### 格式 工具

* [typst-tablex](https://github.com/PgBiel/typst-tablex) ⭐ 414 | 🐛 32 | 🌐 Typst | 📅 2024-10-25: 表格组件, More powerful and customizable tables in Typst.
* [typst-index](https://github.com/RolfBremer/typst-index) ⭐ 84 | 🐛 10 | 🌐 Typst | 📅 2026-03-27: 创建索引的工具库,  Automatically create a handcrafted index in typst. This typst component allows the automatic creation of an Index page with entries that have been manually marked in the document by its authors. This, in times of advanced search functionality, seems somewhat outdated, but a handcrafted index like this allows the authors to point the reader to just the right location in the document.
...
* [typst-canvas](https://github.com/johannes-wolf/typst-canvas) ⭐ 1,831 | 🐛 76 | 🌐 Typst | 📅 2026-08-31: Typst Canvas 库
...
* [typst-color-emoji](https://github.com/silent-dxx/typst-color-emoji) ⭐ 4 | 🐛 0 | 🌐 Typst | 📅 2024-01-27:emoji 库， A simple library for drawing color emoji for Typst. Drawing using twemoji and openmoji open-source emoji libraries.
...
* [typst-theorems](https://github.com/sahasatvik/typst-theorems) ⭐ 287 | 🐛 26 | 🌐 Typst | 📅 2025-06-17: 一个辅助编号的库,A library for creating numbered theorem environments
* [typst-undergradmath](https://github.com/johanvx/typst-undergradmath) ⭐ 150 | 🐛 3 | 🌐 Typst | 📅 2026-04-30: `undergradmath` Typst 移植,A Typst port of [undergradmath](https://gitlab.com/jim.hefferon/undergradmath)
* [typst-undergradmath-zh](https://github.com/AlexanderMisel/typst-undergradmath-zh) ⭐ 9 | 🐛 0 | 🌐 Typst | 📅 2023-12-02 : Typst大学数学，一个大学数学常用符号在Typst中如何输入的总结,A Typst port of undergradmath
* [Formal-Methods-Typst](https://github.com/txtxj/Formal-Methods-Typst) ⭐ 5 | 🐛 0 | 📅 2023-04-21: 用于书写形式化中数理逻辑证明题
* [commutative-diagrams](https://gitlab.com/giacomogallina/typst-cd):交换图/交换图表库， A library for creating commutative diagrams

### 物理 化学 电学

* [typst-physics](https://github.com/Leedehai/typst-physics) ⭐ 611 | 🐛 8 | 🌐 Typst | 📅 2026-07-21: 物理符号库，A library for usual physics notations, e.g. vectors, matrices, derivatives, Dirac brakets, tensors, isotopes
* [circuitypst](https://github.com/fenjalien/circuitypst) ⭐ 165 | 🐛 9 | 🌐 Typst | 📅 2024-04-03: 移植 `circuitikz` 实现电路图形的支持 ,A port of circuitikz to Typst using typst-canvas
...
* [typst.ts](https://github.com/Myriad-Dreamin/typst.ts) ⭐ 1,207 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-31: 在 javascript 环境中渲染 typ 文件 ,Typst.ts allows you to independently run the Typst compiler and exporter (renderer) in your browser.
* [typst-py](https://github.com/messense/typst-py) ⭐ 348 | 🐛 9 | 🌐 Rust | 📅 2026-08-01: Typst 的 Python 绑定, Python binding to typst, a new markup-based typesetting system that is powerful and easy to learn.
...
* [jupyter2typst](https://github.com/dermesser/jupyter2typst) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2023-12-20: 将 `jupyter notebooks` 转换成 `typst ` 代码的工具  ，A handy tool for converting jupyter notebooks into typst code for producing PDFs.
* [Typst xmake](https://github.com/star-hengxing/typst-xmake) ⚠️ Archived: 使用 xmake 编译 typst ,实现伪热更新 , Use xmake as build system to compile typst to pdf.

## 编辑器集成插件

### 通用

* [SeniorMars/tree-sitter-typst](https://github.com/SeniorMars/tree-sitter-typst) ⭐ 170 | 🐛 7 | 🌐 C | 📅 2026-07-28:TreeSitter 插件， A TreeSitter parser for the Typst File Format
...
* [typst-mode.el](https://github.com/Ziqi-Yang/typst-mode.el) ⚠️ Archived: Emacs 插件,An Emacs major mode for the `typst` markup-based typesetting system

### 语言服务 LSP

* [typst-lsp](https://github.com/nvarner/typst-lsp) ⚠️ Archived: typst  lsp， rust 编写，A brand-new language server for Typst, plus a VS Code extension
...
* [typst-preview-vscode](https://github.com/Enter-tainer/typst-preview-vscode) ⚠️ Archived: VSCode Typst 预览插件, Preview your Typst files in vscode instantly
* [Typst LSP VS Code Extension](https://marketplace.visualstudio.com/items?itemName=nvarner.typst-lsp) ,VSCode 插件

### 其他

* [typst-action](https://github.com/lvignoli/typst-action) ⭐ 95 | 🐛 11 | 🌐 Python | 📅 2025-02-16: Github Action 支持,Build Typst documents using GitHub actions
