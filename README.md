...
列表收集了 [Typst](https://github.com/typst/typst) ⭐ 55,922 | 🐛 1,290 | 🌐 Rust | 📅 2026-09-08 相关的资源,扩展，应用等。
...
* [GitHub](https://github.com/typst/typst) ⭐ 55,922 | 🐛 1,290 | 🌐 Rust | 📅 2026-09-08
...
* [awesomeCV-Typst](https://github.com/mintyfrankie/awesomeCV-Typst) ⭐ 835 | 🐛 2 | 🌐 Typst | 📅 2026-08-29 - 一份参考 `Awesome-CV` 的简历模版，支持多语言简历管理, An opinionated, relived CV template inspired by the LaTeX `Awesome-CV` project, but with multilingual support and more
...
* [typst-canvas](https://github.com/johannes-wolf/typst-canvas) ⭐ 1,838 | 🐛 76 | 🌐 Typst | 📅 2026-08-31: Typst Canvas 库
...
* [typst-physics](https://github.com/Leedehai/typst-physics) ⭐ 610 | 🐛 8 | 🌐 Typst | 📅 2026-07-21: 物理符号库，A library for usual physics notations, e.g. vectors, matrices, derivatives, Dirac brakets, tensors, isotopes
...
* [typst.ts](https://github.com/Myriad-Dreamin/typst.ts) ⭐ 1,215 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-31: 在 javascript 环境中渲染 typ 文件 ,Typst.ts allows you to independently run the Typst compiler and exporter (renderer) in your browser.
* [typst-py](https://github.com/messense/typst-py) ⭐ 352 | 🐛 9 | 🌐 Rust | 📅 2026-09-01: Typst 的 Python 绑定, Python binding to typst, a new markup-based typesetting system that is powerful and easy to learn.
...
* [SeniorMars/tree-sitter-typst](https://github.com/SeniorMars/tree-sitter-typst) ⭐ 170 | 🐛 8 | 🌐 C | 📅 2026-07-28:TreeSitter 插件， A TreeSitter parser for the Typst File Format
